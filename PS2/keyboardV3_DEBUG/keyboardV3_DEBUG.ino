/*Debug version of PS/2 to USB adapter with Serial Monitor output 
  written by Chamath Colombage*/
...
void setup() {
  ...
  keyboard.setNoRepeat(30);
  Serial.begin(115200);
  intest(2); //initialized indicator
}
...
void PRINT(){ //Debug output on serial monitor
    for (int y = 0; y  < 8; y++){
      Serial.print(buf[y], DEC);
      Serial.print("  ");
    }
    Serial.println("");
}
